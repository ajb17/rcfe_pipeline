...
# warp_to_152_node = Node(legacy.GenWarpFields(reference_image=template_image, similarity_metric="CC"), name="warp152")
...
# coreg_to_template_space_node = Node(ApplyTransforms(reference_image=template_image, interpolation='BSpline'), name="coreg_to_template_space")
